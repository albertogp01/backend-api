...
const os = require("os");
const { createDynamicCoverPage } = require('./services/chartService');
...
`;
      ...
      await page.setContent(fullPdfHtml, { waitUntil: 'networkidle0' });
      ...
      await page.evaluate(() => {
        ...
        function isNearFooter(element, safetyMargin = 90) {
